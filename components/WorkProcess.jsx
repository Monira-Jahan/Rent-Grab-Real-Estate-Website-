                ...
                <Zoom>
                    <div className='grid grid-cols-1 md:grid-cols-4 mx-auto gap-3 ml-12'>
                        <div className='border-2 border-gray-200 h-full w-3/4 rounded-xl shadow-xl '>
                            ...
                            <h1 className='font-bold text-xl text-center pb-2'>Find real estate</h1>
                        ...
                        <div className='border-2 border-gray-200 h-full w-3/4 rounded-xl shadow-xl'>
                            ...
                            <h1 className='font-bold text-xl text-center pb-2 px-1'>Meet The Relator</h1>
                            <p className='text-sm font-medium px-8 pb-3'>Meet With Relator for finalize the property.</p>

                        </div>
                        <div className='border-2 border-gray-200 h-full w-3/4 rounded-xl shadow-xl'>
                            <img className="w-10 h-10 mx-auto my-3" src="https://i.ibb.co/GFpp6j1/document.png" />
                            <h1 className='font-bold text-xl text-center pb-2'>Documents</h1>
                        ...
                        <div className='border-2 border-gray-200 h-full w-3/4 rounded-xl shadow-xl'>
                            ...
                            <h1 className='font-bold text-xl text-center pb-2'>Take The Keys</h1>
